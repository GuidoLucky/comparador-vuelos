        ...
        const vuelosStr = e.vuelos.map(v => {
          ...
          return `
            <div style="display:flex;justify-content:space-between;align-items:center;padding:10px 0;border-bottom:1px solid #1e1e2e">
              ...
              <a href="${waUrl}" style="background:#25D366;color:#fff;font-size:12px;font-weight:700;padding:8px 14px;border-radius:8px;text-decoration:none;white-space:nowrap;flex-shrink:0;margin-left:12px">Reservar</a>
            </div>`;
        }).join('');
        html += `
