      ...
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#f0f4f8;padding:20px;">
        ...
        <div style="background:white;padding:28px 24px;border-radius:0 0 8px 8px;box-shadow:0 2px 8px rgba(0,0,0,0.1);">
          ...
          <div style="text-align:center;margin:32px 0 20px;">
            <a href="${emisionUrl}" style="background:#c9a84c;color:white;padding:16px 36px;border-radius:8px;text-decoration:none;font-weight:bold;font-size:16px;display:inline-block;">
              ✈️ Solicitar emisión
            </a>
            <p style="margin-top:12px;color:#999;font-size:12px;">Al hacer clic nos avisás que querés emitir el pasaje y nos comunicamos a la brevedad.</p>
          </div>
